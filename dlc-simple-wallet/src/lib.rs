...
pub struct DlcSimpleWallet<B: Deref, W: Deref>
where
...
impl<B: Deref, W: Deref> DlcSimpleWallet<B, W>
where
    B::Target: WalletBlockchainProvider,
    W::Target: WalletStorage,
{
...
impl<B: Deref, W: Deref> Signer for DlcSimpleWallet<B, W>
where
    B::Target: WalletBlockchainProvider,
    W::Target: WalletStorage,
{
    ...
    fn get_secret_key_for_pubkey(&self, pubkey: &PublicKey) -> Result<SecretKey> {
        ...
        //     .expect("to have the requested private key"))
        Ok(self.seckey.clone())
    }
}

impl<B: Deref, W: Deref> Wallet for DlcSimpleWallet<B, W>
where
    B::Target: WalletBlockchainProvider,
    W::Target: WalletStorage,
{
    fn get_new_address(&self) -> Result<Address> {
        ...
        self.storage.upsert_address(&self.address, &self.seckey)?;
...
impl<B: Deref, W: Deref> BatchOperations for DlcSimpleWallet<B, W>
where
    B::Target: WalletBlockchainProvider,
    W::Target: WalletStorage,
{
...
impl<B: Deref, W: Deref> Database for DlcSimpleWallet<B, W>
where
    B::Target: WalletBlockchainProvider,
    W::Target: WalletStorage,
{
